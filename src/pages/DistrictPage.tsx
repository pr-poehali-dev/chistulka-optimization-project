...
export default function DistrictPage() {
  ...
  const seoDescription = `Профессиональная химчистка диванов, кресел, матрасов и ковров ${d.nameGen} Краснодара. Выезд на дом, сушка 2–4 часа, безопасные средства. ☎ 8 918 968-28-82`;
  const keywords = `химчистка мебели ${d.name} Краснодар, химчистка диванов ${d.name}, химчистка на дому ${d.name} Краснодар, химчистка кресел ${d.name}, химчистка матрасов ${d.name}`;
